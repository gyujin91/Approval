...
public class HistoryController {
	...
	/*
	 * @RequestMapping("historyList.do") public String historyList(Model model,
	 * Map<String, Object> map) throws Exception { List<HistoryDTO> dto = new
	 * ArrayList<HistoryDTO>(); approvalService.approvalList(map);
	 * 
